...
import { IDeleteUserInputDTO, IEditInputDTO, IGetUsersArrayResponseOutputDTO, IGetUsersBDDTO, IGetUsersInputDTO, IGetUsersResponseOutputDTO, ILoginInputDTO, ISignupInputDTO, ISignupOutputDTO, User, USER_ROLES } from "../models/User"
...
export class UserBusiness {
    ...
    public getUsers = async (input: IGetUsersInputDTO) => {
        ...
        const getUsersInputDB: IGetUsersBDDTO = {
            search,
            order,
            sort,
            limit,
        ...
        const users = usersDB.map(userDB => {
            ...
            const userResponse: IGetUsersResponseOutputDTO = {
                id: user.getId(),
                name: user.getName(),
                email: user.getEmail()
            }
        ...
        const response: IGetUsersArrayResponseOutputDTO = {
            users
        }
